...
export const metadata = {
  title: 'Terms of Service | MiraiNeticsAI',
  description: 'Terms of Service for MiraiNeticsAI - Enterprise AI and Automation Services.',
};
        ...
        <div className="glass rounded-2xl p-8 md:p-12 border-white/10 shadow-2xl relative overflow-hidden">
          ...
          <div className="space-y-8 text-white/80 leading-relaxed font-light">
            <section className="space-y-4">
              ...
              <p>
                By accessing and using the website and services offered by MiraiNeticsAI ("Company", "we", "us", "our"), you agree to be bound by these Terms of Service. If you do not agree to these terms, you must not access or use our Website or Services.
              </p>
              <p>
            ...
            <section className="space-y-4">
              ...
              <p>
                MiraiNeticsAI provides specialized technology solutions, including but not limited to:
              </p>
            ...
            <section className="space-y-4">
              ...
              <p>
                The Website and its entire contents, features, and functionality (including but not limited to all information, software, algorithms, text, displays, images, video, and audio, and the design, selection, and arrangement thereof) are owned by MiraiNeticsAI, its licensors, or other providers of such material and are protected by international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.
              </p>
              <p>
             ...
             <section className="space-y-4">
              ...
              <p>
                While MiraiNeticsAI strives to implement highly accurate and efficient AI and automation workflows (as indicated by our targets of 99.8% accuracy), AI systems are probabilistic by nature. We do not warrant that the output of our AI systems will be perfectly error-free in every instance. Our services are intended to augment human decision-making and operational efficiency, not necessarily to replace critical human oversight unless explicitly defined in a separate Service Level Agreement.
              </p>
            </section>
